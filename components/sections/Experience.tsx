...
import deloitteWebp from '@/public/images/deloitte.webp'
import nyxaHostingJpg from '@/public/images/nyxa-hosting.jpg'
import nyxaHostingWebp from '@/public/images/nyxa-hosting.webp'
			...
			<section className={'flex w-full flex-col gap-8 border-r-[0.5px] border-b-[0.5px] border-l-[0.5px] border-dashed border-(--border-color) px-4 py-8 sm:w-160'}>
				...
				<div className={'flex gap-3'}>
					<picture className={'shrink-0'}>
						<source srcSet={deloitteWebp.src} type={'image/webp'} />
						<img alt={'Deloitte Logo'} className={'rounded-lg object-cover'} height={32} loading={'eager'} src={deloitteJpg.src} width={32} />
					</picture>
				...
				<div className={'flex gap-3'}>
					<picture className={'shrink-0'}>
						<source srcSet={nyxaHostingWebp.src} type={'image/webp'} />
						<img alt={'Nyxa Hosting Logo'} className={'rounded-lg object-cover'} height={32} loading={'eager'} src={nyxaHostingJpg.src} width={32} />
					</picture>
					<div className={'flex flex-col gap-2'}>
						<div>
